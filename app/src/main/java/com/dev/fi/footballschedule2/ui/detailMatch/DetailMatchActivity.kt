...
import com.dev.fi.footballschedule2.data.database.FavoriteMatch
...
import com.dev.fi.footballschedule2.utils.lineText
...
class DetailMatchActivity : BaseActivity(), DetailMatchV {
    ...
    companion object {
        var detailCountingIdlingResouce = CountingIdlingResource("DETAILMATCH")
    }
